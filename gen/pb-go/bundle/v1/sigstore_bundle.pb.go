...
type VerificationMaterial struct {
	...
	//     MUST be a leaf certificate conveying the signing key.
	//
	...
	//     handle old or non-complying bundles that have additional intermediate and/or
	//     root CA certificates.
	//
	//  3. A single X.509 certificate, which MUST be a leaf certificate conveying
	//     the signing key.
	//
	// When used with the Public Good Instance (PGI) of Sigstore, form (1) MUST NOT be used,
	// regardless of bundle version.
	//
	// When used in a `0.1` or `0.2` bundle with the PGI, form (2) MUST be used.
	//
	// When used in a `0.3` bundle with the PGI, form (3) MUST be used.
	//
