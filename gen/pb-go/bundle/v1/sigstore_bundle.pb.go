...
type Bundle struct {
	...
	TlogEntries []*v11.TransparencyLogEntry `protobuf:"bytes,2,rep,name=tlog_entries,json=tlogEntries,proto3" json:"tlog_entries,omitempty"`
	// Timestamp verification data, over the artifact's signature.
	TimestampVerificationData *TimestampVerificationData `protobuf:"bytes,3,opt,name=timestamp_verification_data,json=timestampVerificationData,proto3" json:"timestamp_verification_data,omitempty"`
	VerificationMaterial      *v1.VerificationMaterial   `protobuf:"bytes,4,opt,name=verification_material,json=verificationMaterial,proto3" json:"verification_material,omitempty"`
...
func (x *Bundle) GetTlogEntries() []*v11.TransparencyLogEntry {
	if x != nil {
...
func (x *Bundle) GetTimestampVerificationData() *TimestampVerificationData {
	if x != nil {
...
type Bundle_MessageSignature struct {
	MessageSignature *v1.MessageSignature `protobuf:"bytes,5,opt,name=message_signature,json=messageSignature,proto3,oneof"`
}
...
type Bundle_DsseEnvelope struct {
	...
	DsseEnvelope *dsse.Envelope `protobuf:"bytes,6,opt,name=dsse_envelope,json=dsseEnvelope,proto3,oneof"`
}
...
var file_sigstore_bundle_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x73, 0x22, 0xf3, 0x03, 0x0a, 0x06, 0x42, 0x75, 0x6e,
	...
	0x70, 0x65, 0x12, 0x4e, 0x0a, 0x0c, 0x74, 0x6c, 0x6f, 0x67, 0x5f, 0x65, 0x6e, 0x74, 0x72, 0x69,
	0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x73,
	...
	0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x73, 0x69,
	...
	,
	...
	,
	...
	0x73, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x70, 0x62, 0x2d, 0x67, 0x6f, 0x2f, 0x62, 0x75, 0x6e, 0x64,
...
var file_sigstore_bundle_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_sigstore_bundle_proto_goTypes = []interface{}{
	...
	(*Bundle)(nil),                    // 1: dev.sigstore.bundle.v1.Bundle
	(*v1.RFC3161SignedTimestamp)(nil), // 2: dev.sigstore.common.v1.RFC3161SignedTimestamp
	(*v11.TransparencyLogEntry)(nil),  // 3: dev.sigstore.rekor.v1.TransparencyLogEntry
	(*v1.VerificationMaterial)(nil),   // 4: dev.sigstore.common.v1.VerificationMaterial
	(*v1.MessageSignature)(nil),       // 5: dev.sigstore.common.v1.MessageSignature
	(*dsse.Envelope)(nil),             // 6: io.intoto.Envelope
}
var file_sigstore_bundle_proto_depIdxs = []int32{
	2, // 0: dev.sigstore.bundle.v1.TimestampVerificationData.rfc3161_timestamps:type_name -> dev.sigstore.common.v1.RFC3161SignedTimestamp
	3, // 1: dev.sigstore.bundle.v1.Bundle.tlog_entries:type_name -> dev.sigstore.rekor.v1.TransparencyLogEntry
	0, // 2: dev.sigstore.bundle.v1.Bundle.timestamp_verification_data:type_name -> dev.sigstore.bundle.v1.TimestampVerificationData
	4, // 3: dev.sigstore.bundle.v1.Bundle.verification_material:type_name -> dev.sigstore.common.v1.VerificationMaterial
	5, // 4: dev.sigstore.bundle.v1.Bundle.message_signature:type_name -> dev.sigstore.common.v1.MessageSignature
	6, // 5: dev.sigstore.bundle.v1.Bundle.dsse_envelope:type_name -> io.intoto.Envelope
