...
const (
	...
	HashAlgorithm_SHA2_256_192               HashAlgorithm = 2
...
type KnownSignatureAlgorithm int32

const (
	KnownSignatureAlgorithm_KNOWN_SIGNATURE_ALGORITHM_UNSPECIFIED KnownSignatureAlgorithm = 0
	KnownSignatureAlgorithm_RSA_SIGN_PKCS1_2048_SHA256            KnownSignatureAlgorithm = 1
	KnownSignatureAlgorithm_RSA_SIGN_PKCS1_3072_SHA256            KnownSignatureAlgorithm = 2
	KnownSignatureAlgorithm_RSA_SIGN_PKCS1_4096_SHA256            KnownSignatureAlgorithm = 3
	KnownSignatureAlgorithm_ECDSA_SHA2_256_NISTP256               KnownSignatureAlgorithm = 4
	KnownSignatureAlgorithm_ECDSA_SHA2_384_NISTP384               KnownSignatureAlgorithm = 5
	KnownSignatureAlgorithm_ECDSA_SHA2_512_NISTP521               KnownSignatureAlgorithm = 6
	KnownSignatureAlgorithm_ED25519                               KnownSignatureAlgorithm = 7
	KnownSignatureAlgorithm_ED25519_PH                            KnownSignatureAlgorithm = 8
)

// Enum value maps for KnownSignatureAlgorithm.
var (
	KnownSignatureAlgorithm_name = map[int32]string{
		0: "KNOWN_SIGNATURE_ALGORITHM_UNSPECIFIED",
		1: "RSA_SIGN_PKCS1_2048_SHA256",
		2: "RSA_SIGN_PKCS1_3072_SHA256",
		3: "RSA_SIGN_PKCS1_4096_SHA256",
		4: "ECDSA_SHA2_256_NISTP256",
		5: "ECDSA_SHA2_384_NISTP384",
		6: "ECDSA_SHA2_512_NISTP521",
		7: "ED25519",
		8: "ED25519_PH",
	}
	KnownSignatureAlgorithm_value = map[string]int32{
...
func (x KnownSignatureAlgorithm) Enum() *KnownSignatureAlgorithm {
	p := new(KnownSignatureAlgorithm)
	*p = x
	return p
}

func (x KnownSignatureAlgorithm) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (KnownSignatureAlgorithm) Descriptor() protoreflect.EnumDescriptor {
	return file_sigstore_common_proto_enumTypes[2].Descriptor()
}

func (KnownSignatureAlgorithm) Type() protoreflect.EnumType {
	return &file_sigstore_common_proto_enumTypes[2]
}

func (x KnownSignatureAlgorithm) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use KnownSignatureAlgorithm.Descriptor instead.
func (KnownSignatureAlgorithm) EnumDescriptor() ([]byte, []int) {
...
var file_sigstore_common_proto_rawDesc = []byte{
	...
	0x64, 0x88, 0x01, 0x01, 0x42, 0x06, 0x0a, 0x04, 0x5f, 0x65, 0x6e, 0x64, 0x2a, 0x79, 0x0a, 0x0d,
	...
	0x08, 0x53, 0x48, 0x41, 0x32, 0x5f, 0x32, 0x35, 0x36, 0x10, 0x01, 0x12, 0x10, 0x0a, 0x0c, 0x53,
	0x48, 0x41, 0x32, 0x5f, 0x32, 0x35, 0x36, 0x5f, 0x31, 0x39, 0x32, 0x10, 0x02, 0x12, 0x0c, 0x0a,
	0x08, 0x53, 0x48, 0x41, 0x32, 0x5f, 0x35, 0x31, 0x32, 0x10, 0x03, 0x12, 0x0c, 0x0a, 0x08, 0x53,
	0x48, 0x41, 0x33, 0x5f, 0x32, 0x35, 0x36, 0x10, 0x04, 0x12, 0x0c, 0x0a, 0x08, 0x53, 0x48, 0x41,
	0x33, 0x5f, 0x33, 0x38, 0x34, 0x10, 0x05, 0x2a, 0xd9, 0x01, 0x0a, 0x10, 0x50, 0x75, 0x62, 0x6c,
	0x69, 0x63, 0x4b, 0x65, 0x79, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x22, 0x0a, 0x1e,
	0x50, 0x55, 0x42, 0x4c, 0x49, 0x43, 0x5f, 0x4b, 0x45, 0x59, 0x5f, 0x44, 0x45, 0x54, 0x41, 0x49,
	...
	0x39, 0x10, 0x07, 0x2a, 0x98, 0x02, 0x0a, 0x17, 0x4b, 0x6e, 0x6f, 0x77, 0x6e, 0x53, 0x69, 0x67,
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x41, 0x6c, 0x67, 0x6f, 0x72, 0x69, 0x74, 0x68, 0x6d, 0x12,
	0x29, 0x0a, 0x25, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x5f, 0x53, 0x49, 0x47, 0x4e, 0x41, 0x54, 0x55,
	...
	,
	...
	0x7c, 0x0a, 0x1c, 0x64, 0x65, 0x76, 0x2e, 0x73, 0x69, 0x67, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e,
	...
	0x6d, 0x6f, 0x6e, 0x2f, 0x76, 0x31, 0xea, 0x02, 0x14, 0x53, 0x69, 0x67, 0x73, 0x74, 0x6f, 0x72,
...
var file_sigstore_common_proto_goTypes = []interface{}{
	...
	(KnownSignatureAlgorithm)(0),      // 2: dev.sigstore.common.v1.KnownSignatureAlgorithm
