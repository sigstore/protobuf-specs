...
module Sigstore
  module TrustRoot
    module V1
      ...
      WitnessConfiguration = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dev.sigstore.trustroot.v1.WitnessConfiguration").msgclass
      WitnessGroup = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dev.sigstore.trustroot.v1.WitnessGroup").msgclass
      Witness = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dev.sigstore.trustroot.v1.Witness").msgclass
      ...
      ServiceConfiguration = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dev.sigstore.trustroot.v1.ServiceConfiguration").msgclass
      ...
      ServiceSelector = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dev.sigstore.trustroot.v1.ServiceSelector").enummodule
    end
  end
end
