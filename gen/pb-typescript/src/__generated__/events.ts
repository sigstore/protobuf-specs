...
export const CloudEvent: MessageFns<CloudEvent> = {
    ...
    return {
      ...
      attributes: isObject(object.attributes)
        ? (globalThis.Object.entries(object.attributes) as [string, any][]).reduce(
          (acc: { [key: string]: CloudEvent_CloudEventAttributeValue }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: CloudEvent_CloudEventAttributeValue.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
  ...
  toJSON(message: CloudEvent): unknown {
    ...
    if (message.attributes) {
      const entries = globalThis.Object.entries(message.attributes) as [string, CloudEvent_CloudEventAttributeValue][];
      if (entries.length > 0) {
        obj.attributes = {};
        entries.forEach(([k, v]) => {
